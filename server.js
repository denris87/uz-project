...
app.get("/schedule", (req, res) => {
  ...
  const infoBoard = {
    ...
    messages: [
      {
        text: "№6015 Дніпро-Гол. – Пʼятихатки-Пас. прямує зі станції Верхньодніпровськ з затримкою +39 хвилин"
      },
      {
        text: "№6018 Пʼятихатки-Стик. – Дніпро-Гол. зі станції Верхньодніпровськ з затримкою +47 хвилин"
      }
    ]
  };
